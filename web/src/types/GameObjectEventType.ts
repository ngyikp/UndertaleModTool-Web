...
export const EventSubtypeStepValues = reverseObject(EventSubtypeStep);

/// <summary>
/// The subtypes for <see cref="EventType.Draw"/>.
/// </summary>
export const EventSubtypeDraw = {
	/// <summary>
	/// The draw event.
	/// </summary>
	Draw: 0,
...
export const EventSubtypeKeyValues = reverseObject(EventSubtypeKey);

/// <summary>
/// The subtypes for <see cref="EventType.Mouse"/>.
/// </summary>
export const EventSubtypeMouse = {
	/// <summary>
...
export const EventSubtypeMouseValues = reverseObject(EventSubtypeMouse);

/// <summary>
/// The subtypes for <see cref="EventType.Other"/>.
/// </summary>
export const EventSubtypeOther = {
	/// <summary>
...
export const EventSubtypeOtherValues = reverseObject(EventSubtypeOther);

/// <summary>
/// The subtypes for <see cref="EventType.Gesture"/>.
/// </summary>
export const EventSubtypeGesture = {
	/// <summary>
	/// The tap event.
	/// </summary>
	Tap: 0,

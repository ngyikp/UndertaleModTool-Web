...
export const EmbeddedTextureInfoDotNetSchema = z.object({
	...
	BgraFileName: z.nullable(z.string()),
	Format: z.enum(ImageFormatEnum),
	Width: z.int(),
	Height: z.int(),
});

// Downstream users shouldn't need to know about the virtual filesystem internals
